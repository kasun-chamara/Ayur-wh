      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-12 col-lg-6 text-center text-lg-start mb-5 mb-lg-0">
            <h5 className="subhero animate__animated animate__fadeInUp animate__delay-1s">
              WAHARAKA HELA OSU
            </h5>
            <h2
            ...
            <div className="d-flex justify-content-center justify-content-lg-start gap-3 animate__animated animate__fadeInUp animate__delay-2s">
              <button className="btn custom-green px-4" onClick={openVideo}>
                Discover More
              </button>
              <button
                className="btn btn-outline-light btn-lg rounded-circle video-btn pulse-animation"
                onClick={openVideo}
              >
                <FaPlay />
              </button>
          ...
          <div className="col-12 col-lg-6 d-flex justify-content-center justify-content-lg-end mt-4 mt-lg-0">
            <div className="hero-img-wrapper d-flex align-items-center animate__animated animate__zoomIn animate__delay-2s w-100 mobile-hero-img-margin">
              <img
                src={RightImg}
        ...
        <div className="video-modal-overlay" onClick={closeVideo}>
          <div className="video-modal" onClick={e => e.stopPropagation()}>
            ...
            <video
              ...
              controls
              autoPlay
              style={{ borderRadius: '16px', background: '#000', maxWidth: '98vw', maxHeight: '70vh' }}
            />
          </div>
        </div>
      )}
